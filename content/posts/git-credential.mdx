---
title: 'Multi-Account Git Setup Guide Using SSH'
description: 'A comprehensive guide to configuring multiple Git accounts using SSH keys'
date: '2024-03-21'
tags: ['git']
series: 'Git'
seriesNumber: 1
...
3. Git 리포지토리 클론 및 사용<br/>
   이제 각각의 SSH 설정을 이용해 Git 리포지토리를 클론하거나, 푸시/풀 작업을 수행할 수 있습니다. 클론할 때 URL 형식에서 github-user1: 또는 github-user2: 형식을 사용합니다. SSH config에 `User git`이 설정되어 있으므로 `git@` 접두사는 생략해도 되고 붙여도 됩니다.
