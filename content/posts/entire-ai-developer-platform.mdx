...
전 GitHub CEO **Thomas Dohmke**가 2025년 8월 퇴임을 발표하고, 2025년 말 GitHub을 떠난 뒤 2026년 2월에 런칭한 프로젝트입니다. **6천만 달러(약 870억 원)의 시드 라운드**를 3억 달러 밸류에이션으로 유치했는데, 이는 개발자 도구 역사상 최대 규모의 시드 투자입니다. Felicis가 리드하고, Madrona, Basis Set, Microsoft의 벤처 펀드인 M12가 참여했습니다.
...
| SubagentStart / SubagentStop | 서브에이전트 생성·완료 모니터링 |
...
아직 초기 단계이고 현재 Claude Code와 Gemini CLI를 지원하며 OpenCode, Cursor, Factory AI Droid, Copilot CLI 등으로 확대되는 과정이지만, "AI 에이전트의 작업 맥락을 구조적으로 보존한다"는 방향 자체는 에이전트 기반 개발이 확산될수록 필수적인 인프라가 될 가능성이 높습니다.
