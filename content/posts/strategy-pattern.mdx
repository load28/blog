...
description: 'Exploring the concept of the Strategy pattern and its implementation in Kotlin'
date: '2024-09-03:00:00Z'
tags: ['design-pattern']
---

전략 패턴(Strategy Pattern)은 특정 행위를 다양한 알고리즘으로 캡슐화하여 변경되는 내용만 독립적으로 관리할 수 있게 해주는 디자인 패턴입니다.
...
이처럼 새로운 로그인 방식이 추가되더라도 기존 코드를 수정하지 않고 새로운 클래스를 추가하는 방식으로 확장이 가능합니다.
