...
description: 'Understanding the Command Pattern: A design pattern that encapsulates requests as objects for flexible and maintainable code'
...
커맨드 패턴은 요청을 객체로 캡슐화하여 실행 취소, 큐잉, 로깅 등을 가능하게 하고 새로운 커맨드 추가 시 기존 코드를 수정하지 않아도 됩니다.
