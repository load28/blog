...
# VSCode ESLint 확장이 node_modules/eslint를 찾음 ✅
```
...
# 루트에 아무것도 없음!
# VSCode ESLint 확장: ❌ Cannot find module 'eslint'
```
...
```typescript
// node_modules/malicious-pkg/index.js
const eslint = require('eslint'); // ❌ Error: Cannot find module
...
{
  "pnpm": {
    "shamefully-hoist": true  // ❌ v10의 보안 강화 무효화
  }
}
```
...
const eslint = require('eslint'); // ❌ Error
```
