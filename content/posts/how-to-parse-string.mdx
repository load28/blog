...
### 논리적 구조
유니코드는 17개 평면(Plane, 0~16번)으로 나뉘며 이는 전체 코드 공간을 17개의 동일한 크기로 나눈 구역을 의미합니다. 현재는 전체 크기 중에 약 15% 정도만 사용하고 있어
...
| 15 | 사용자 정의 영역 A<br/>(Supplementary Private Use Area-A) | U+F0000 ~ U+FFFFF | 개인이나 조직이<br/>자유롭게 사용 |
| 16 | 사용자 정의 영역 B<br/>(Supplementary Private Use Area-B) | U+100000 ~ U+10FFFF | 개인이나 조직이<br/>자유롭게 사용 |
...
- 가 = ᄀ(L) + ᅡ(V)
- é = e + ́ ́(Extend)
- င်္ဂ = င(Base) + ်(Extend) + ္(Extend) + ဂ(Base)
